...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - ' : '' }}Luxury Interior Design</title>
                ...
                <div class="flex justify-between h-20">
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="nav-logo flex items-center group">
                            <img src="{{ asset('images/logo/logo.png') }}" alt="Company Logo" class="h-20 w-auto group-hover:scale-105 transition-transform duration-300">
                        </a>
                    </div>
                    
                    <!-- Desktop Menu -->
                    <div class="hidden lg:flex items-center space-x-1">
                        <a href="{{ route('home') }}" class="nav-link nav-item text-gray-700 hover:text-purple-600 px-4 py-2 text-sm font-medium rounded-lg hover:bg-purple-50 transition duration-300 {{ request()->routeIs('home') ? 'text-purple-600 bg-purple-50' : '' }}">Home</a>
                        <a href="{{ route('history') }}" class="nav-link nav-item text-gray-700 hover:text-purple-600 px-4 py-2 text-sm font-medium rounded-lg hover:bg-purple-50 transition duration-300 {{ request()->routeIs('history') ? 'text-purple-600 bg-purple-50' : '' }}">History</a>
                        <a href="{{ route('portfolio') }}" class="nav-link nav-item text-gray-700 hover:text-purple-600 px-4 py-2 text-sm font-medium rounded-lg hover:bg-purple-50 transition duration-300 {{ request()->routeIs('portfolio') ? 'text-purple-600 bg-purple-50' : '' }}">Portfolio</a>
                        <a href="{{ route('location') }}" class="nav-link nav-item text-gray-700 hover:text-purple-600 px-4 py-2 text-sm font-medium rounded-lg hover:bg-purple-50 transition duration-300 {{ request()->routeIs('location') ? 'text-purple-600 bg-purple-50' : '' }}">Location</a>
                        <a href="{{ route('contact') }}" class="nav-link nav-item text-gray-700 hover:text-purple-600 px-4 py-2 text-sm font-medium rounded-lg hover:bg-purple-50 transition duration-300 {{ request()->routeIs('contact') ? 'text-purple-600 bg-purple-50' : '' }}">Contact</a>
                        
                        @auth
                            <div class="ml-4 pl-4 border-l border-gray-200">
                                <a href="{{ route('dashboard') }}" class="nav-btn gradient-bg text-white px-6 py-2.5 rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 font-medium">Dashboard</a>
                            </div>
                        @else
                            <div class="ml-4 pl-4 border-l border-gray-200">
                                <a href="{{ route('login') }}" class="nav-btn gradient-bg text-white px-6 py-2.5 rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 font-medium">Login</a>
                            </div>
                        @endauth
                    </div>
            ...
            <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="col-span-1 md:col-span-2">
                        <div class="flex items-center space-x-3 mb-6">
                            ...
                            <div>
                                <h3 class="text-xl font-heading font-bold">Luxury Interior</h3>
                        ...
                        <ul class="space-y-3 text-gray-300">
                            <li class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">info@luxuryinterior.com</p>
                                </div>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 mr-3 mt-0.5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-12 pt-8 border-t border-gray-700">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <p class="text-gray-400 text-sm">&copy; {{ date('Y') }} Luxury Interior Design Studio. All rights reserved.</p>
