                            ...
                            <div class="md:flex">
                                ...
                                <div class="md:w-1/3">
                                    @if($progress->foto && $progress->foto !== '')
                                        <img src="{{ asset('storage/' . $progress->foto) }}" alt="Progress Update" class="w-full h-64 md:h-full object-cover">
                                    @else
        ...
        let content = `
            <div class="space-y-4">
                ${progress.foto && progress.foto !== '' ? 
                    `<img src="{{ asset('storage/') }}/${progress.foto}" alt="Progress Update" class="w-full h-auto rounded-lg">` : 
