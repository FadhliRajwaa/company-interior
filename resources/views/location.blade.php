...
<section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-purple-100 max-w-4xl mx-auto leading-relaxed">
            Kunjungi showroom luxury kami dan rasakan langsung kualitas material premium serta konsep desain terdepan. Tim expert siap memberikan konsultasi personal untuk mewujudkan impian interior Anda.
        </p>
    </div>
</section>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 leading-relaxed">
                                    Jl. Design Center No. 123<br>
                                    Kemang, Jakarta Selatan 12560<br>
                                    Indonesia
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="flex items-center space-x-3 p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors duration-300 group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 font-semibold">+62 21 1234 5678</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-3 p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-colors duration-300 group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 font-semibold">info@luxuryinterior.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-3 p-4 bg-indigo-50 rounded-xl hover:bg-indigo-100 transition-colors duration-300 group">
                            ...
                            <div>
                                ...
                                <p class="text-gray-900 font-semibold">www.luxuryinterior.com</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-bg rounded-xl p-6 border border-purple-200 border-opacity-20">
                        ...
                        <div class="space-y-3 text-gray-700">
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 border-opacity-50">
                                ...
                                <span class="text-purple-600 font-semibold">09:00 - 18:00</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 border-opacity-50">
                                <span class="font-medium">Sabtu</span>
                                <span class="text-purple-600 font-semibold">09:00 - 15:00</span>
                            </div>
                            <div class="flex justify-between items-center py-2">
                                <span class="font-medium">Minggu</span>
                                <span class="text-orange-600 font-semibold">Appointment Only</span>
                            </div>
                        </div>
                        <div class="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                            <p class="text-sm text-yellow-800">
                                <span class="font-medium">Note:</span> Konsultasi VIP di luar jam operasional dapat dijadwalkan terlebih dahulu melalui WhatsApp.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative">
                        <div class="aspect-video bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center">
                            <div class="text-center">
                                ...
                                <p class="text-purple-400 text-sm">Kemang, Jakarta Selatan</p>
                            </div>
                        </div>
...
<section class="py-20 bg-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="text-purple-600 font-semibold text-sm uppercase tracking-wider">Transportation</span>
            <h2 class="text-4xl lg:text-5xl font-heading font-bold text-gray-900 mt-2 mb-6">
                Cara Menuju Showroom
            </h2>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Berbagai pilihan transportasi premium untuk mencapai showroom luxury kami dengan nyaman dan mudah
            </p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- MRT -->
            <div class="group bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">MRT Jakarta</h3>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Stasiun Blok M (5 menit jalan kaki dari showroom kami)
                </p>
                <div class="text-sm text-gray-500 space-y-2">
                    <div class="flex items-center justify-between">
                        <span>Dari Bundaran HI:</span>
                        <span class="font-semibold text-blue-600">15 menit</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span>Dari Lebak Bulus:</span>
                        <span class="font-semibold text-blue-600">20 menit</span>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                <div class="w-20 h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <svg class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 13v-1a4 4 0 014-4 4 4 0 014 4v1m0 6a1 1 0 01-1 1H9a1 1 0 01-1-1v-6a1 1 0 011-1h6a1 1 0 011 1v6z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-3">TransJakarta</h3>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Halte Blok M (2 menit jalan kaki dari showroom)
                </p>
                <div class="text-sm text-gray-500 space-y-2">
                    <div class="flex items-center justify-between">
                        <span>Koridor 1:</span>
                        <span class="font-semibold text-red-600">Blok M - Kota</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span>Koridor 12:</span>
                        <span class="font-semibold text-red-600">Blok M - Pluit</span>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Kendaraan Pribadi</h3>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Valet parking tersedia di lobby showroom
                </p>
                <div class="text-sm text-gray-500 space-y-2">
                    <div class="flex items-center justify-between">
                        <span>Dari Tol TB Simatupang:</span>
                        <span class="font-semibold text-green-600">10 menit</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span>Dari Pondok Indah:</span>
                        <span class="font-semibold text-green-600">15 menit</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-4xl lg:text-5xl font-heading font-bold text-white mb-6">
                Ready untuk Kunjungan VIP?
            </h2>
            <p class="text-xl text-purple-100 mb-10 leading-relaxed">
                Jadwalkan private consultation dengan tim expert kami. Nikmati layanan personal shopper untuk material luxury dan dapatkan konsep design eksklusif untuk ruang impian Anda.
            </p>
            ...
            <div class="mt-8 flex items-center justify-center space-x-8 text-purple-100">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-sm">Personal Designer</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 mr-2 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                    <span class="text-sm">3D Preview</span>
                </div>
            </div>
        </div>
    </div>
