...
<section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-purple-100 max-w-4xl mx-auto leading-relaxed">
            Mari diskusikan proyek interior luxury impian Anda. Tim profesional kami siap memberikan konsultasi terbaik dan solusi yang tepat sesuai visi Anda.
        </p>
    </div>
</section>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">info@luxuryinterior.com</p>
                                <p class="text-gray-600">consultation@luxuryinterior.com</p>
                            </div>
                        </div>
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors duration-300">
                ...
                <p class="text-gray-600">Ya, kami memberikan garansi 2 tahun untuk konstruksi dan 1 tahun untuk furniture custom. After-sales service tersedia 24/7 untuk maintenance dan support.</p>
            </div>
            
            <div class="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors duration-300">
                <h3 class="text-lg font-semibold text-gray-900 mb-3">Bagaimana sistem pembayaran yang tersedia?</h3>
                <p class="text-gray-600">Kami menyediakan sistem pembayaran fleksibel: DP 30%, progress payment 40%, dan pelunasan 30%. Tersedia cicilan 0% untuk project di atas 100 juta dengan partner bank terpercaya.</p>
            </div>
            
            <div class="bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-colors duration-300">
                <h3 class="text-lg font-semibold text-gray-900 mb-3">Apakah bisa melihat preview 3D sebelum eksekusi?</h3>
                <p class="text-gray-600">Tentu! Kami menggunakan teknologi VR dan 3D visualization untuk memberikan preview realistis. Anda dapat "merasakan" ruang sebelum konstruksi dimulai.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <p class="text-xl text-purple-100 mb-10">
                Jangan biarkan ruang impian Anda hanya menjadi khayalan. Mari wujudkan bersama tim expert kami dengan standar luxury international.
            </p>
