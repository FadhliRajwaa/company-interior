...
<section class="relative min-h-[60vh] flex items-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-base sm:text-xl text-purple-100 max-w-4xl mx-auto leading-relaxed px-2">
            Koleksi karya eksklusif kami yang menampilkan berbagai gaya dan konsep desain interior luxury dengan standar internasional
        </p>
    </div>
</section>
...
<section class="py-20 bg-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div class="group">
                <div class="text-4xl font-heading font-bold text-purple-600 mb-2 group-hover:scale-110 transition-transform duration-300">1000+</div>
                <div class="text-gray-600 font-medium">Proyek Selesai</div>
            </div>
            <div class="group">
                <div class="text-4xl font-heading font-bold text-blue-600 mb-2 group-hover:scale-110 transition-transform duration-300">15+</div>
            ...
            <div class="group">
                <div class="text-4xl font-heading font-bold text-orange-600 mb-2 group-hover:scale-110 transition-transform duration-300">25+</div>
                <div class="text-gray-600 font-medium">Desainer Expert</div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-12 sm:py-20 bg-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10 sm:mb-16">
            ...
            <p class="text-sm sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
                Setiap project yang kami kerjakan didukung oleh tim professional dengan pengalaman internasional dan teknologi terdepan.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div class="text-center group">
                ...
                <p class="text-sm sm:text-base text-gray-600 leading-relaxed px-2">Menggunakan material berkualitas tinggi dan standar internasional dalam setiap project.</p>
            </div>
            ...
            <div class="text-center group">
                ...
                <p class="text-sm sm:text-base text-gray-600 leading-relaxed px-2">99% tingkat kepuasan klien dengan garansi after-sales service yang comprehensive.</p>
            </div>
            ...
            <div class="text-center group">
                ...
                <p class="text-sm sm:text-base text-gray-600 leading-relaxed px-2">Menggunakan software 3D modeling dan VR visualization untuk preview hasil akhir.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <p class="text-base sm:text-xl text-purple-100 mb-8 sm:mb-10 px-4">
                Mari wujudkan ruang impian Anda dengan sentuhan luxury dan professional yang sama. Tim expert kami siap membantu merealisasikan visi desain interior Anda.
            </p>
